...
class UserControllerTest {
    ...
    void testGetById() throws Exception {
        ...
        when(userService.getById(Mockito.<Long>any())).thenReturn(ofResult);
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/v1/user/{id}", 1L);
    ...
    void testUpdate() throws Exception {
        ...
        //   test threw
        //   java.lang.ClassCastException: class com.olegnew.jvcboxv1.model.User cannot be cast to class com.olegnew.jvcboxv1.dto.UserResponseDto (com.olegnew.jvcboxv1.model.User and com.olegnew.jvcboxv1.dto.UserResponseDto are in unnamed module of loader com.diffblue.cover.g.g @33acddf8)
        //       at com.olegnew.jvcboxv1.controller.UserController.update(UserController.java:143)
        ...
        MockHttpServletRequestBuilder contentTypeResult = MockMvcRequestBuilders.put("/v1/user/update/{id}", 2L)
                .contentType(MediaType.APPLICATION_JSON);

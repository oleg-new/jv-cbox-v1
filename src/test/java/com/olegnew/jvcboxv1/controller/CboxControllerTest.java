...
class CboxControllerTest {
    ...
    /**
     * Method under test: {@link CboxController#getById(String)}
     */
    @Test
    ...
    void testGetById() {
        ...
        //       at com.olegnew.jvcboxv1.controller.CboxController.getById(CboxController.java:45)
        //       at javax.servlet.http.HttpServlet.service(HttpServlet.java:655)
        //       at javax.servlet.http.HttpServlet.service(HttpServlet.java:764)
        //   See https://diff.blue/R013 to resolve this issue.

        CboxServiceImpl cboxService = new CboxServiceImpl(mock(CboxRepository.class));
        (new CboxController(cboxService, new ModelMapper())).getById("42");
    }
    ...
    void testUpdate() {
        ...
        //   test threw
        //   java.lang.NullPointerException: Cannot invoke "org.springframework.security.core.Authentication.getAuthorities()" because "authentication" is null
        //       at com.olegnew.jvcboxv1.controller.CboxController.update(CboxController.java:73)
        //       at javax.servlet.http.HttpServlet.service(HttpServlet.java:764)
        //   See https://diff.blue/R013 to resolve this issue.

        CboxServiceImpl cboxService = new CboxServiceImpl(mock(CboxRepository.class));
        CboxController cboxController = new CboxController(cboxService, new ModelMapper());

        FullInformationRequestDto fullInformationRequestDto = new FullInformationRequestDto();
        fullInformationRequestDto.setHouse("House");
        fullInformationRequestDto.setReceivedInformation(new HashMap<>());
        fullInformationRequestDto.setStreet("Street");
        cboxController.update("42", fullInformationRequestDto);
    }
    ...
    /**
     * Method under test: {@link CboxController#reboot(String)}
     */
    @Test
    void testReboot() throws Exception {
        ...
        when(cboxService.getById(Mockito.<String>any())).thenReturn(ofResult);

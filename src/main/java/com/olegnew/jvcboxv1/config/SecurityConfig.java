...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.PUT, "/v1/cbox/**").hasAnyRole("OPERATOR")
                .antMatchers(HttpMethod.POST, "/v1/cbox/**").hasAnyRole("OPERATOR")
                .antMatchers(HttpMethod.PATCH, "/v1/cbox/**").hasAnyRole("OPERATOR")
